...
#ifndef TWEETLISTMODELABSTRACT_H
#define TWEETLISTMODELABSTRACT_H

#include <QObject>
#include <QHash>

class TweetListModelAbstract : public QObject
{
    Q_OBJECT
public:
    TweetListModelAbstract(QObject *parent = 0);
...
#endif // TWEETLISTMODELABSTRACT_H
